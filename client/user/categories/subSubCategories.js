Template.subSubCategories.helpers({
	...
	subCategoryOptions:function(){
		...
		var rootParentCat = Categories.findOne({_id: parentCategory}).parentCategory;
		return {
			sortField: 'order',
			group: {
                name: "rootCategory",
			...
			onAdd: function(event) {
				...
				Session.set( "CurrentSelection", rootParentCat );
				Session.set( "CurrentSubSelection", parentCategory );
            }
		}
	}
});
